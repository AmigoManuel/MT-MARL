...
def StoreResults(name):
    ...
    try:
        ...
        print
        "No se pudo procesar el mapa " + name
...
if __name__ == '__main__':
    if len(sys.argv) < 2:  # There is argumens
        ...
        'Example:'
        print
        './rtaa-auto.py map/randommaze RUNS InitialLookAhead STEPLookAhead ENDLookAhead FOLDER/FILE Folder/file'
        print
        './rtaa-auto.py map 100 10 4 200 folder ../Maps/Dragon_Age_Origins/'
